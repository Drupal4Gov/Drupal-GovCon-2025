...
import allAnnouncementData from '@organisms/all-announcement/all-announcement.yml';

export default {
  title: 'Pages/Announcement Listing Page',
  component: allAnnouncementPage,
};

const Template = (args) => allAnnouncementPage(args);
